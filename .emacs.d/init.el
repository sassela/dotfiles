...
(use-package haskell-mode
  ...
  (add-hook 'haskell-mode-hook
            '(lambda ()
               ...
               (setq-local select-all-targets '(eval . (with-current-buffer (intero-buffer 'backend)
                                               (intero-destroy)
                                               (intero-get-worker-create 'backend
                                                                         '("almanac:exe:almanac" "apiary:lib" "apiary:exe:apiary" "apiary:exe:apiary-orgsync" "apiary:test:apiary-test" "bean:lib" "bean:exe:bean-activate-pkgs" "bean:exe:bean-api" "bean:test:bean-test" "ca-essays:lib" "ca-essays:exe:ca-essays-api" "ca-essays:test:essays-spec" "ca-financials:lib" "ca-financials:exe:ca-financials-api" "ca-financials:exe:ca-financials-import" "ca-financials:test:financials-spec" "ca-milestones:lib" "ca-milestones:exe:ca-milestones-api" "ca-milestones:test:milestones-spec" "concord:lib" "concord:exe:concord-api" "concord:exe:concord-relay" "concord:test:concord-test" "cv-base:lib" "cv-base:test:cv-base-test" "direct-scheduling:lib" "direct-scheduling:exe:direct-scheduling" "direct-scheduling:test:ds-test" "dna:lib" "dna:test:dna-test" "dna-bridge:exe:WriteMyCVDNA" "espalier:lib" "espalier:exe:espalier" "espalier:test:espalier-test" "gourd:lib" "gourd:exe:gourd" "gourd:exe:gourd-emit-paired-events" "gourd:exe:hsImport" "gourd:exe:publish-guardians" "gourd:test:gourd-test" "grape:lib" "grape:exe:grape-api" "grape:exe:grape-recycle-mobile-numbers" "grape:exe:grape-renderer" "grape:test:grape-test" "kiwi:lib" "kiwi:exe:kiwi-api" "kiwi:exe:kiwi-relays" "kiwi:test:kiwi-test" "lentil:lib" "lentil:exe:lentil-api" "lentil:test:lentil-spec" "loranth:lib" "loranth:exe:loranth-api" "loranth:test:loranth-test" "nursery:lib" "nursery:exe:nursery-api" "nursery:exe:nursery-tasks" "nursery:exe:nursery-update-pairing-stage" "nursery:test:nursery-test" "pepper:lib" "pepper:exe:pepper-user-flags" "platform-client:lib" "platform-client:test:platform-client-test" "pomodoro:lib" "pomodoro:exe:pomodoro-api" "pomodoro:exe:pomodoro-calendar-importer" "pomodoro:exe:pomodoro-publish-notes" "pomodoro:exe:pomodoro-session-exporter" "pomodoro:exe:pomodoro-tasks" "pomodoro:test:pomodoro-examples" "pomodoro:test:pomodoro-test" "rer:lib" "rer:exe:rer-api" "rer:test:rer-spec" "rtc:lib" "rtc:exe:rtc" "rtc:test:rtc-test" "trellis:lib" "trellis:exe:trellis-api" "trellis:exe:trellis-publisher" "trellis:test:trellis-test" "wharf:lib" "wharf:exe:wharf-api" "wharf:test:wharf-test" "workspaces:lib" "workspaces:exe:workspaces-api" "workspaces:exe:workspaces-decentralize-pairings" "workspaces:exe:workspaces-tasks-autogrant" "workspaces:test:workspaces-test" "ws-college-apps:lib" "ws-college-apps:exe:ws-college-apps-api" "ws-college-apps:exe:ws-college-apps-decentralize-pairings" "ws-college-apps:test:ws-apps-tests" "ws-common:lib")
                                               (current-buffer)))))
               (hlint-refactor-mode)
               (intero-mode)
               (ghc-init)))
